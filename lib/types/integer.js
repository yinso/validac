...
var Integer = /** @class */ (function (_super) {
    ...
    Integer.fromJSON = function (v, path) {
        if (path === void 0) { path = '$'; }
        return exports.convertInteger.assert(v, path);
    };
    Integer.convertIntegerString = string_1.isString
        .where(string_1.match(/^[+-]?\d+$/))
        .transform(function (v) { return new Integer(parseInt(v)); });
    Integer.convertIntegerNumber = number_1.isNumber
...
exports.isInteger = isa_1.isa(Integer.isInteger, 'Integer');
exports.isInteger.appendConvert(Integer.convertIntegerNumber);
exports.isInteger.appendConvert(Integer.convertIntegerString);
exports.convertInteger = exports.isInteger.toConvert();
