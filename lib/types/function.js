...
const { BaseIsaValidator , isa } = require('../isa');
require('reflect-metadata');

var isFunction = isa(function(v) { return typeof(v) === 'function' || (v instanceof Function); }, 'function');
...
module.exports = {
    ...
    bindAsyncFunction: bindAsyncFunction,
