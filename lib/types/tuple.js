...
class IsaTupleValidator extends BaseIsaValidator {
    ...
    _toConvert() {
        return new ConvertTupleValidator(this.validators.map((v) => v.toConvert()))
    }
}
...
function convertTuple(...validators) {
    return new ConvertTupleValidator(validators);
}

exports = module.exports = {
    isTuple: isTuple,
    convertTuple: convertTuple
};
