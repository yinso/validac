...
exports.isString.appendConvert(isa_1.isa(function (v) { return v == undefined; }, 'undefined').transform(function () { return ''; }));
exports.isString.appendConvert(isa_1.isa(function (v) { return v == null; }, 'null').transform(function () { return ''; }));
exports.isString.appendConvert(isa_1.isa(function (v) { return v instanceof Date; }, 'Date').transform(function (v) { return v.toISOString(); }));
exports.isString.appendConvert(any_1.isAny.transform(function (v) { return v.toString(); }));
exports.convertString = exports.isString.toConvert();
