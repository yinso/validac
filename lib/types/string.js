...
exports.isString = validator_1.isa(function (value) { return typeof (value) === 'string'; }, 'string');
var MatchConstraint = /** @class */ (function (_super) {
    ...
    MatchConstraint.prototype.validate = function (v, path) {
        if (this.pattern.test(v)) {
            return constraint_1.Success(v);
        }
        else {
            return constraint_1.Failure({
...
var MinLengthConstraint = /** @class */ (function (_super) {
    ...
    MinLengthConstraint.prototype.satisfy = function (v) {
        return this.inclusive ? v.length >= this.minLength : v.length > this.minLength;
    };
    MinLengthConstraint.prototype.validate = function (v, path) {
        if (this.satisfy(v)) {
            return constraint_1.Success(v);
        }
        else {
...
var MaxLengthConstraint = /** @class */ (function (_super) {
    ...
    MaxLengthConstraint.prototype.satisfy = function (v) {
        return this.inclusive ? v.length <= this.maxLength : v.length < this.maxLength;
    };
    MaxLengthConstraint.prototype.validate = function (v, path) {
        if (this.satisfy(v)) {
            return constraint_1.Success(v);
        }
        else {
