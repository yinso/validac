...
var Uuid = /** @class */ (function (_super) {
    ...
    function Uuid(inner) {
        return _super.call(this, exports.isUuidString.toConvert().assert(inner || uuid.v4())) || this;
    }
    ...
    Uuid.fromJSON = function (v, path) {
        if (path === void 0) { path = '$'; }
        return exports.isUuid.toConvert().assert(v, path);
    };
...
exports.convertUuid = exports.isUuid.toConvert();
