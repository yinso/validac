...
var ArrayIsaValidator = /** @class */ (function (_super) {
    ...
    ArrayIsaValidator.prototype.validate = function (arg, path) {
        ...
        arg.forEach(function (item, i) {
            (_isa_1.isIsaValidator(_this.inner) ? _this.inner : _this.inner()).validate(item, path + '[' + i + ']')
    ...
    ArrayIsaValidator.prototype._toConvert = function (options) {
        return new ArrayConvertValidator((_isa_1.isIsaValidator(this.inner) ? this.inner : this.inner()).toConvert(options), options);
    };
...
var ArrayConvertValidator = /** @class */ (function (_super) {
    ...
    ArrayConvertValidator.prototype.validate = function (arg, path) {
        ...
        var errors = [];
        arg.forEach(function (item, i) {
            (_isa_1.isConvertValidator(_this.inner) ? _this.inner : _this.inner()).validate(item, path + '[' + i + ']')
                .cata(function (value) {
                if (value !== item) {
                    changed = true;
                }
