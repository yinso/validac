...
var TaggedObjectFactoryIsaValidator = /** @class */ (function (_super) {
    ...
    TaggedObjectFactoryIsaValidator.prototype._toConvert = function () {
        var _a;
        return new TaggedObjectFactoryConvertValidator(this.objectKey, (_a = {}, _a[this.objectKey] = string_1.isString.toConvert(), _a), this.inner.toConvert(), this.registry);
    };
...
var TaggedObjectFactoryConvertValidator = /** @class */ (function (_super) {
    ...
    function TaggedObjectFactoryConvertValidator(key, validatorMap, inner, registry) {
        var _this = _super.call(this) || this;
        _this.objectKey = key;
        _this.validatorMap = validatorMap;
        _this.inner = inner;
    ...
    TaggedObjectFactoryConvertValidator.prototype.validate = function (value, path) {
        ...
        return this.inner.validate(value, path)
            .cata(function (v) {
            if (v.hasOwnProperty(_this.objectKey) && _this.registry.has(v[_this.objectKey])) {
                return _this.registry.get(v[_this.objectKey]).toConvert().validate(v, path);
            }
            else {
                return base_1.ValidationResult.reject({
                    error: 'UnknownTag',
