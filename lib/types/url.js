...
var Url = /** @class */ (function (_super) {
    ...
    Url.convertUrl = exports.isUrlString
        .transform(function (v) { return new Url(v); });
    return Url;
}(scalar_1.Scalar));
exports.Url = Url;
exports.isUrl = isa_1.isa(Url.isUrl, 'Url');
exports.convertUrl = exports.isUrl.transform(function (v) { return v; }).union(Url.convertUrl);
exports.isUrl.toConvert = function () { return exports.convertUrl; };
