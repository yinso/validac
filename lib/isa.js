...
exports.isa = isa;
exports.isAny = isa(function (arg) { return true; }, 'Any');
function isLiteral(value, typeName) {
    return isa(function (v) { return v === value; }, typeName || value.toString());
}
exports.isLiteral = isLiteral;
exports.isNull = isLiteral(null, 'null');
exports.isUndefined = isLiteral(undefined, 'undefined');
