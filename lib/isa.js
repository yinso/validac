...
OptionalIsaValidator.prototype._toConvert = function toConvert(options) {
    return new OptionalConvertValidator(this.validator.toConvert(options));
}
...
DefaultToIsaValidator.prototype._toConvert = function (options) {
    return new DefaultToConvertValidator(this.validator.toConvert(options), this.defualtToProc);
}
...
ConstraintIsaValidator.prototype._toConvert = function toConvert(options) {
    return new ConstraintConvertValidator(this.validator.toConvert(options), this.constraint);
}
