...
function isInstanceof(Obj, typeName) {
    return new TypeofIsaValidator((v) => v instanceof Obj, typeName);
}
...
UnionIsaValidator.prototype.push = function push(validator) {
    this.validators = this.validators.concat([ validator ]);
}

UnionIsaValidator.prototype.unshift = function unshift(validator) {
