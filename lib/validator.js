...
BaseValidator.prototype.transform = function to(transform) {
...
AsyncBaseValidator.prototype.and = function and (validator) {
    return new AndValidator([this, validator]);
}

AsyncBaseValidator.prototype.or = function or(validator) {
    return new OrValidator([this, validator]);
}
...
AsyncAndValidator.prototype.and = function and(validator) {
...
AsyncOrValidator.prototype.or = function or(validator) {
